...
class AddSubMathGameManager(context: Context) {
    private val questions: List<ArithmeticQuestion> = buildQuestions(context)
    ...
    companion object {
        fun allQuestions(context: Context): List<ArithmeticQuestion> = buildQuestions(context)

        private fun buildQuestions(context: Context): List<ArithmeticQuestion> {
