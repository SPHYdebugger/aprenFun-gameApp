...
class SocialGameActivity : BaseActivity() {
    private lateinit var binding: ActivityGameBinding
    private lateinit var gameManager: SocialGameManager
    ...
    private var topic: Int = SocialGameManager.TOPIC_SOLAR_SYSTEM
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        topic = intent.getIntExtra(EXTRA_TOPIC, SocialGameManager.TOPIC_SOLAR_SYSTEM)
        gameManager = SocialGameManager(this, topic)
    ...
    private fun goToResults() {
        val intent = Intent(this, ResultActivity::class.java).apply {
            ...
            putExtra(ResultActivity.EXTRA_GAME_MODE, ScoreManager.MODE_SOCIAL)
            putExtra(ResultActivity.EXTRA_SOCIAL_TOPIC, topic)
        }
