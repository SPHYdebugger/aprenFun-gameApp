...
class AddSubMathGameActivity : BaseActivity() {
    ...
    private val gameManager by lazy { AddSubMathGameManager(this) }
    ...
    private fun showQuestion(resetTimer: Boolean) {
        ...
        binding.questionText.text = question.expression
    ...
    private fun showWrongDialog() {
        val dialog = AlertDialog.Builder(this, R.style.ThemeOverlay_Aprendemos_AlertDialog)
            .setMessage(getString(R.string.math_add_sub_wrong_message_format, currentExpression, currentAnswer))
    ...
    private fun goToResults() {
        val intent = Intent(this, ResultActivity::class.java).apply {
            ...
            putExtra(ResultActivity.EXTRA_MATH_TYPE, MathTopicsActivity.TYPE_ADD_SUB)
        }
